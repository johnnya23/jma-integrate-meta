...
<div class="row">
    <select class="crop_position" name="attachment[<?php echo $slide_id; ?>][jma_caption_position]">
        ...
        <option value="left-center" <?php echo selected($jma_caption_position, 'left-center', false); ?>> <?php _e("Center Left", "ml-slider"); ?></option>
        <option value="center-center" <?php echo selected($jma_caption_position, 'center-center', false); ?>> <?php _e("Center Center", "ml-slider"); ?></option>
        <option value="right-center" <?php echo selected($jma_caption_position, 'right-center', false); ?>> <?php _e("Center Right", "ml-slider"); ?></option>
